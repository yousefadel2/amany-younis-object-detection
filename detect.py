...
# MQTT settings
broker_address = "192.168.190.179"  # Replace with your MQTT broker address
topic = "test"  # Replace with your MQTT topic
...
def detect(save_img=False):
    ...
    source="C:/Users/FreeComp/Desktop/test_images/sent/image.JPEG"
    webcam = source.isnumeric() or source.endswith('.txt') or source.lower().startswith(
        ('rtsp://', 'rtmp://', 'http://', 'https://'))

    # Directories
    save_dir = Path("C:/Users/FreeComp/Desktop/test_images")  # increment run
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    print(f'Detected: {names[int(cls)]} ')

            # Print time (inference + NMS)
            text_to_speak = f'detected :{s}'
            speak(text_to_speak)
...
def on_message(client, userdata, msg):
    ...
    if request_counter >= max_requests:
        ...
        client.disconnect()
        print("Maximum number of requests reached. Disconnecting from MQTT broker.")
...
if __name__ == '__main__':
    while True:
        ...
        parser.add_argument('--source', type=str, default='C:/Users/FreeComp/Desktop/test_image/sent/', help='source')  # file/folder, 0 for webcam
